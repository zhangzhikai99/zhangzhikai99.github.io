...
import { MeshLine, MeshLineMaterial, MeshLineRaycast } from './three.meshiline/src/THREE.MeshiLine.js';
...
const fogLikelihood = 0.001; // Probability of fog appearing per 1 frame
let foglevel = 0;
const skySpeed = 0.5 //
